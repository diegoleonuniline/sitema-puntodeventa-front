...
function cargarEmpresa() {
    API.request('/empresas/' + API.getEmpresaID()).then(function(r) {
        if (r.success && r.empresa) {
            ...
            document.getElementById('emp_fecha_vencimiento').value = e.fecha_vencimiento || '';
            // Puntos
...
function cargarUnidades() {
    API.request('/unidades-medida/' + API.getEmpresaID()).then(function(r) {
        if (r.success) {
            unidades = r.unidades || [];
            renderUnidades();
        }
...
function guardarUnidad(e) {
    ...
    var url = editing ? '/unidades-medida/' + editing : '/unidades-medida';
